...
model_temp.load_state_dict(torch.load('./CNN-l2-freeze-prob/beta-10.pt'))
...
if __name__ == '__main__':
    for j in [1, 1.5, 2, 5, 10, 15, 20, 30, 50, 100]:
        priority = j
        print(alpha, priority)
        ref_model.load_state_dict(state_dict)
        model.load_state_dict(state_dict)
        residual_train()
        loc = "./CNN-l2-freeze-prob/potential-best-target-p-" + str(j) + ".pt"
