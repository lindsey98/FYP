...
#
#
# torch.save(torch.vstack(feature_list), "./data/CNN-l2-30-A_B-feature.pt")
correct_list = torch.load("./data/CNN-l2-30-A_B-result.pt")
feature_list = torch.load("./data/CNN-l2-30-A_B-feature.pt")
