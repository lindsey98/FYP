...
correct_list = list()
with torch.no_grad():
    state_dict = torch.load('../CNN-l2-30/A_and_B-reinit.pt')
...
torch.save(torch.hstack(correct_list), "./data/CNN-l2-30-A_B-reinit-result.pt")

result = torch.load("./data/CNN-l2-30-A_B-reinit-result.pt")
print(result.shape)
