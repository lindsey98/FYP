...
# correct_list = list()
# with torch.no_grad():
#     state_dict = torch.load('../CNN-Train/CIFAR_11_6/false_epoch-2000.pt')
...
#     correct_list = list()
#     with torch.no_grad():
#         state_dict = torch.load('../CNN-Train/CIFAR_11_6/back_epoch-%s.pt' % i)
#         model.load_state_dict(state_dict)
#
#         start_index = 0
#         for data, target in evaluation_data_loader:
...
#     print(i)
#
# torch.save(torch.vstack(result_list), "./data/CNN-30-CIFAR_11_6-back-result.pt")

result = torch.load("./data/CNN-30-CIFAR_11_6-back-result.pt")

correct_for_train = torch.load("./data/CNN-30-CIFAR_11_6-lower_10.pt")
...
plt.title("Accuracy Trend For CIFAR_11_6")
