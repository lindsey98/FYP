...
#     correct_list = list()
#     with torch.no_grad():
#         state_dict = torch.load('../CNN-30/lower_10_back/%s.pt' % i)
...
#     print(i)
#
# torch.save(torch.vstack(result_list), "./data/CNN-30-lower_10-back-result_2.pt")

result_1 = torch.load("./data/CNN-30-lower_10-result.pt")
result_2 = torch.load("./data/CNN-30-lower_10-back-result_2.pt")
