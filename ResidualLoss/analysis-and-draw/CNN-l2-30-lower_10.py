...
#     correct_list = list()
#     with torch.no_grad():
#         state_dict = torch.load('../CNN-30/lower_10/%s.pt' % i)
...
#     print(i)
#
# torch.save(torch.vstack(result_list), "./data/CNN-30-lower_10-result.pt")

result = torch.load("./data/CNN-30-lower_10-result.pt")
