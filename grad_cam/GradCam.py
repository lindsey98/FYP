...
from grad_cam.GradCamModel import GradCamForOldSiamese
...
if __name__ == '__main__':
    ...
    grad_cam_model = GradCamForOldSiamese(model=model, feature_module=model.base_net.layer4, target_layer_names=["2"])
